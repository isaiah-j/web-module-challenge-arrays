...
function copy(originalArr) {
	let newArr = [ ...originalArr ];
	return newArr;
}

let copiedArr = copy(originalFlavors)
...
function getAverageWordLength(arr) {
	...
	for (let i = 0; i < arr.length; i++) {
		wordCount += arr[i].split(' ').length;
	}
	let average = wordCount / arr.length;
	return average;
}
